...
uint8_t bg_gattdb_data_attribute_field_22_data[20]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_16_data = {
	.len=0,
...
GATT_DATA(const struct bg_gattdb_attribute_chrvalue	bg_gattdb_data_attribute_field_16 ) = {
	...
	.index=1,
	.max_len=20,
	.data_varlen=&bg_gattdb_data_attribute_field_16_data,
};

GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_15 ) = {
	.len=19,
	.data={0x18,0x11,0x00,0xc1,0x3c,0x35,0x55,0x28,0x11,0xe1,0xaa,0x76,0x48,0x42,0xb0,0x80,0xd7,0xad,0xe7,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_6 ) = {
	.len=19,
	.data={0x52,0x64,0x50,0x6b,0x48,0x44,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000a,.permissions=0x800,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_2},
    {.uuid=0x000b,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x02,.index=0x00,.clientconfig_index=0x00}},
    ...
    {.uuid=0x8001,.permissions=0x802,.caps=0xffff,.datatype=0x02,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_16},
    {.uuid=0x000b,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x01,.clientconfig_index=0x01}},
    ...
    {.uuid=0x8003,.permissions=0x802,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_20},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.min_key_size=0x00,.constdata=&bg_gattdb_data_attribute_field_21},
    {.uuid=0x8004,.permissions=0x804,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_22},
};
