...
#define LED_1_PIN               (6)
#define LED_1_PORT              (gpioPortF)

#define LED_2_PIN               (7)
#define LED_2_PORT              (gpioPortF)

#define WSTK_UART_1_PIN         (5)
#define WSTK_UART_1_PORT        (gpioPortA)

#define WSTK_UART_2_PIN         (3)
#define WSTK_UART_2_PORT        (gpioPortA)
