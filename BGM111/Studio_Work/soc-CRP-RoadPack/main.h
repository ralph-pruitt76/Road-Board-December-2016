...
#define BUFFSIZE		1536		// Transmit Buffer Size
...
#define VERSION_NUM     "1.5"                 // Monitor Revision
#define REL_DATE        "Jan 27, 2018"
#define LEGACY_BANNER   "1.5 1/27/18"        // Needed to allow Legacy Design to work
